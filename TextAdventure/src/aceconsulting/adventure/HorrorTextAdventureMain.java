...
public class HorrorTextAdventureMain {

	public static void main(String[] args) {
		World theWorld = new HorrorWorld();
		Player thePlayer = new Player(theWorld.getStartLocation());

		System.out
				.println("Welcome to Simple Text Adventure! (Type 'q' to exit.)");
		...
		while (!input.equals("q")) {
			...
			try {
				...
				if (!input.equals("q")) {
					...
					System.out
							.println("Please choose a number from the list, or type 'q' to quit.");
					System.out.println();
				}
			}
		}
		System.out
				.println("Cowardly adventurer -- you are not up to the challenge!");
		console.close();
	}
